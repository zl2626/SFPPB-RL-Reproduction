...
for k = 1:n
    ...
    if (r.algorithm=="main" || r.algorithm=="proposed") ...
            && isfield(r.signals,'Wdiff1_norm') ...
            && ~isempty(r.signals.Wdiff1_norm.Data)
        wd1 = r.signals.Wdiff1_norm.Data(end);
        wd2 = r.signals.Wdiff2_norm.Data(end);
    else
        wd1 = NaN; wd2 = NaN;
    end
    ...
    report(k,:) = {r.algorithm,r.comparison_group,r.example_id, ...
        ...
        violation,dcount,dfrac,dmax,J,exc1,exc2,wd1,wd2};
end
